...
class pascalVOCLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        for j,row in enumerate(lbl):
            for i,col in enumerate(row):
                ...
                cl[col][j][i] = 1
        lbl = cl
        print("I am at __getitem__ and self.split is {}".format(self.split))
        print("The files dict has keys: {}".format(self.files.keys()))
        print("It has statistics : \n\
        	train: {}\n\
        	val: {}\n\
        	train_aug: {}\n\
        	trainval : {}\n\
        	".format(len(self.files['train']),
        		len(self.files['val']),
        		len(self.files['train_aug']),
        		len(self.files['trainval'])))
    ...
    def setup(self, pre_encode=False):
        sbd_path = "/media/sangeet/Stuff/DC Shares/Datasets/VOCdevkit/benchmark_RELEASE/"
        voc_path = "/media/sangeet/Stuff/DC Shares/Datasets/VOCdevkit/VOC2012/"
...
if __name__ == '__main__':
    local_path = "/media/sangeet/Stuff/DC Shares/Datasets/VOCdevkit/VOC2012/"
    pu.db
